...
$admin = $client = $message = $sweet = "";

// Processing form data when form is submitted
if($_SERVER["REQUEST_METHOD"] == "POST"){

    if(empty($_POST['admin']) || empty($_POST['client']) || empty($_POST['message'])){
        $sweet = 'error';
...
$sql = "INSERT INTO custmessages (admin, client, message) VALUES (?, ?, ?)";

if($stmt = mysqli_prepare($conn, $sql)){
// Bind variables to the prepared statement as parameters
mysqli_stmt_bind_param($stmt, "sss", $param_admin, $param_client, $param_message);
