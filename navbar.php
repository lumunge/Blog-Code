...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="login.php">News&Updates</a>
      <a class="collapse-item" href="login.php">AboutUs</a>
      <a class="collapse-item" href="contact.php">ContactUs</a>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link" href="orders.php" id="" role="button" data-toggle="" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-bell fa-fw"></i>
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter">
                <?php
          require 'dbconfig.php';
          $query = "SELECT id FROM bookings ORDER BY id";
